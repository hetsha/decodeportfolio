...
export interface ApiCinematicStoryCinematicStory
  extends Struct.CollectionTypeSchema {
  collectionName: 'cinematic_stories';
  info: {
    description: 'Featured cinematic story entries with image and video';
    displayName: 'Cinematic Story';
    pluralName: 'cinematic-stories';
    singularName: 'cinematic-story';
  };
  options: {
  ...
  attributes: {
    category: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Weddings'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cinematic-story.cinematic-story'
    > &
      Schema.Attribute.Private;
    playLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Play Cinematic Film'>;
    publishedAt: Schema.Attribute.DateTime;
    sectionLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'THE STORY OF TODAY'>;
    showreelCta: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'WATCH SHOWREEL'>;
    showreelDuration: Schema.Attribute.String;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video: Schema.Attribute.Media<'videos'>;
    watermarkLeft: Schema.Attribute.String;
    watermarkRight: Schema.Attribute.String;
  };
}

export interface ApiFormOptionFormOption extends Struct.CollectionTypeSchema {
  collectionName: 'form_options';
  info: {
    description: 'Dropdown options for forms (event types, destinations, services)';
    displayName: 'Form Option';
    pluralName: 'form-options';
    singularName: 'form-option';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Client booking inquiries from the portfolio site';
    displayName: 'Inquiry';
  ...
  attributes: {
    ...
    guestCount: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inquiry.inquiry'
    ...
    source: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'portfolio-website'>;
...
export interface ApiProcessStepProcessStep extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Steps in the instant reels process';
...
export interface ApiReelReel extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Video reels for the hero carousel';
    displayName: 'Reel';
    pluralName: 'reels';
    singularName: 'reel';
  };
  ...
  attributes: {
    ...
    instagramPostId: Schema.Attribute.String;
    ...
    posterUrl: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services offered by the studio';
    displayName: 'Service';
    pluralName: 'services';
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    turnaroundTime: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSiteSettingSiteSetting extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Key-value site configuration settings';
...
export interface ApiStoryChapterStoryChapter
  extends Struct.CollectionTypeSchema {
  collectionName: 'story_chapters';
  info: {
    description: 'Featured story chapters for the portfolio';
    displayName: 'Story Chapter';
    pluralName: 'story-chapters';
    singularName: 'story-chapter';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    coverImage: Schema.Attribute.Media<'images'>;
    coverUrl: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    instagramUrl: Schema.Attribute.String;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::story-chapter.story-chapter'
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    polaroidImage: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::cinematic-story.cinematic-story': ApiCinematicStoryCinematicStory;
      'api::form-option.form-option': ApiFormOptionFormOption;
      ...
      'api::story-chapter.story-chapter': ApiStoryChapterStoryChapter;
