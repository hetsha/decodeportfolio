...
export const IndianLotusBotanicalSvg: React.FC<MotifProps> = ({
  ...
  const shouldAnimate = draw || animated;
  const animState = draw ? 'visible' : animated ? 'visible' : 'hidden';
  ...
  return (
    ...
    >
      <g stroke={color} strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Column Capital Bands Left */}
        <motion.path d="M60,280 L115,280" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M65,290 L110,290" variants={archVariants} initial="hidden" animate={animState} />

        {/* Column Capital Bands Right */}
        <motion.path d="M335,280 L390,280" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M340,290 L385,290" variants={archVariants} initial="hidden" animate={animState} />

        {/* Left Fluted Pillar Lines */}
        <motion.path d="M68,290 L68,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M78,290 L78,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M88,290 L88,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M98,290 L98,580" variants={archVariants} initial="hidden" animate={animState} />

        {/* Right Fluted Pillar Lines */}
        <motion.path d="M352,290 L352,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M362,290 L362,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M372,290 L372,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M382,290 L382,580" variants={archVariants} initial="hidden" animate={animState} />

        {/* Column Base Bands */}
        <motion.path d="M60,580 L115,580" variants={archVariants} initial="hidden" animate={animState} />
        <motion.path d="M335,580 L390,580" variants={archVariants} initial="hidden" animate={animState} />
      </g>
    </svg>
  );
};
